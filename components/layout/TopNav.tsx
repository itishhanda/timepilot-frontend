        ...
        <DialogContent className="sm:max-w-[600px] p-0 overflow-hidden rounded-2xl border bg-card/95 backdrop-blur-xl">
          <div className="flex items-center border-b px-4 py-3">
            ...
            <input
              ...
              autoFocus
            />
            <kbd className="hidden md:inline-flex h-5 select-none items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[10px] font-medium opacity-100 text-muted-foreground">ESC</kbd>
          </div>
